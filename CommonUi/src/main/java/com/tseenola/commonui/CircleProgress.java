...
public class CircleProgress extends View {
    ...
    public CircleProgress(Context context, @Nullable AttributeSet attrs) {
        ...
        mFinishText = typedArray.getString(R.styleable.CircleProgress_when_progress_finish_text);
        typedArray.recycle();
        //初始化圆环背景画笔
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(mFinishText) && TextUtils.equals(percentStr,"100%")){
            percentStr = mFinishText;
